                ...
                <form action="{{ route('budgeting.expenses.update', $expense) }}" method="POST" class="space-y-4">
                    ...
                    <label class="block text-sm font-medium text-slate-700 dark:text-slate-200">
                        ...
                        <textarea name="description" rows="3"
                            class="mt-2 block w-full rounded-3xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-200 dark:border-slate-700 dark:bg-slate-950 dark:text-white">{{ old('description', $expense->description) }}</textarea>
                    </label>
